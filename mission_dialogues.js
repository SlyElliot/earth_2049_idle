...
function canonicalMissionFactionId(factionId) {
...
function showMissionDialogue(missionId) {
    ...
    // Determine faction
    const factionId = canonicalMissionFactionId(getFactionFromMissionId(missionId));
...
function updateMissionsTab() {
    ...
    if (activeMissionIds.length === 0) {
        ...
        activeMissionIds.forEach(missionId => {
            ...
            const factionName = canonicalMissionFactionId(dialogue ? dialogue.faction : getFactionFromMissionId(missionId));
