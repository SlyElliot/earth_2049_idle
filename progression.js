...
function initStoryEvents() {
    gameState.progression.storyEvents = {
        welcomeMessage: {
            ...
            action: () => {
                setTimeout(() => {
                    showModal("Welcome to Earth 2049",
                        `<p>In the neon-lit streets of Earth 2049, GigaCorp rules with an iron fist. You're just starting your journey to build a rebellion.</p>
        ...
        aiLabUnlocked: { // Renamed from researchCampusUnlocked
            triggered: false,
            condition: () => gameState.territories &&
                gameState.territories.artificialIntelligenceLab &&
                gameState.territories.artificialIntelligenceLab.unlocked,
            action: () => {
